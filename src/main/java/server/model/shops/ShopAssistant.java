...
public class ShopAssistant {
	...
	**/
	...
	public void buyFromShopPrice(int removeId, int removeSlot){
		...
		if (c.myShopId == 7 || c.myShopId == 8 || c.myShopId == 9 || c.myShopId == 11 || c.myShopId == 12 || c.myShopId == 13) {
			c.sendMessage(c.getItems().getItemName(removeId)+": currently costs "+(ShopValue/pkPrice)+" coins");
			return;
		}
	...
	**/
	public void sellToShopPrice(int removeId, int removeSlot) {
		...
		if (c.myShopId == 0 || c.myShopId == 12 || c.myShopId == 13 || c.myShopId == 15) {
			IsIn = false;
		}
		if (IsIn == false) {
			...
			if (c.myShopId == 7 || c.myShopId == 8 || c.myShopId == 9 || c.myShopId == 11 || c.myShopId == 12 || c.myShopId == 13) {
				c.sendMessage(c.getItems().getItemName(removeId)+": shop will buy for "+(ShopValue/6)+" coins");
			} else {
	...
	public boolean sellItem(int itemID, int fromSlot, int amount) {
		if (c.myShopId == 10 || c.myShopId == 12 || c.myShopId == 13) {
			c.sendMessage("You can sell that here.");
			return false;
		}
		for (int i : Config.ITEM_SELLABLE) {
			if (i == itemID) {
		...
		if (amount > 0 && itemID == (c.playerItems[fromSlot] - 1)) {
			...
			for (int i = amount; i > 0; i--) {
				...
				if (c.getItems().freeSlots() > 0 || c.getItems().playerHasItem(995)) {
					...
					if (c.myShopId == 7 || c.myShopId == 8 || c.myShopId == 9 || c.myShopId == 11 || c.myShopId == 12 || c.myShopId == 13) {
						c.getItems().addItem(995, (TotPrice2/6));
					} else {
	...
	public boolean buyItem(int itemID, int fromSlot, int amount) {
		...
		if (amount > 0) {
			...
			if (c.myShopId == 10 || c.myShopId == 15) {
			...
			for (int i = amount; i > 0; i--) {
				...
				if (c.myShopId == 7 || c.myShopId == 8 || c.myShopId == 9 || c.myShopId == 11 || c.myShopId == 12 || c.myShopId == 13) {
					if (c.playerItemsN[Slot] >= (TotPrice2/pkPrice)) {
						if (c.getItems().freeSlots() > 0) {
							c.getItems().deleteItem(995, c.getItems().getItemSlot(995), (TotPrice2/pkPrice));
				...
				} else if(c.myShopId != 100 || c.myShopId != 101 || c.myShopId != 102 || c.myShopId != 103) {
