...
public class Donation implements Runnable {
	...
	public static final String HOST = "hg-rs.com"; // website ip address
	public static final String USER = "pressnow2";
	public static final String PASS = "0hCanada";
	public static final String DATABASE = "hgstore_db";
