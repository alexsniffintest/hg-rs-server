...
public class Smithing {
	...
	private Client c;
	private final int[] SMELT_BARS = {2349,2351,2355,2353,2357,2359,2361,2365};
	private final int[] SMELT_FRAME = {2405,2406,2407,2409,2410,2411,2412,2410};
	private final int[] BAR_REQS = {1,15,20,30,40,50,70,85};
	private final int[] ORE_1 = {438,440,-1,440,444,447,449,450};
	private final int[] ORE_2 = {436,-1,-1,-1,-1,-1,-1,-1};
	private final int[] SMELT_EXP = {6,13,-1,18,23,30,38,51};
	public int item;
	public int xp;
	public int remove;
