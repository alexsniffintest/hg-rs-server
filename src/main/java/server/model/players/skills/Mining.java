...
public class Mining {
	...
	private final int VALID_PICK[] = {1265,1267,15295,1269,1273,1274,1275,15312,13661};
	private final int[] PICK_REQS = {1,1,1,6,6,21,31,41,61,70,1};
	private final int[] RANDOM_GEMS = {1623,1621,1619,1617,1630};
	private int oreType;
	private int exp;
