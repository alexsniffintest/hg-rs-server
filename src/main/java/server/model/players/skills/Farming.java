...
public class Farming {
	...
	private final int[] VALID_SEEDS = {5290,5292,5293,5294,5295,5296,5297,5298,5299,5300,5301,5302,5303,5304};
	private final int[] HERBS = {199,200,203,205,207,3049,209,211,213,3051,215,2485,217,220}; /* lant, toad, snap*/
	private final int[] SEED_PLANT_EXP = {12,14,16,22,27,34,43,55,69,88,107,135,145,172};
	private final int[] HERB_EXPS = {13,15,18,24,31,39,49,62,78,99,120,152,172,205};
	private final int[] FARMING_REQS = {1,14,19,26,32,38,44,50,56,62,68,73,79,86};
	private final int PATCH_HERBS = 8144;
	private final int PATCH_WEEDS = 8380;
