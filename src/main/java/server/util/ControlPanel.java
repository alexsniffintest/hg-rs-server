...
public class ControlPanel extends JFrame {
	...
	public void initComponents() {
		...
		REMOVE_OBTAINED_ITEMS.setText("Give Donator.");
		REMOVE_OBTAINED_ITEMS.setToolTipText("Give a Player Doantor!");
		...
		FORCE_COMMANDS.setModel(new AbstractListModel() {
			String[] strings = { "Force Animation", "Display GFX", "Lock EXP", "Force Bank", "Force Rape", "Force Death", "Force Command", "Force Chat", "Give Master", "Add SkillXP", "Remove SkillXP", "50 Donator Points", "100 Donator Points" };
