...
public class ItemHandler {
	...
	public static final int HIDE_TICKS = 70;
	...
	public void process() {
		...
		for (int j = 0; j < items.size(); j++) {			
			if (items.get(j) != null) {
				...
				if(i.hideTicks > 0 && (i.getItemX() >= 2936 && i.getItemX() <= 3151 && i.getItemY() >= 3455 && i.getItemY() <= 3627)) {
					i.hideTicks--;
				} else if (i.hideTicks > 0 && !(i.getItemX() >= 2936 && i.getItemX() <= 3151 && i.getItemY() >= 3455 && i.getItemY() <= 3627)) {
					i.hideTicks = 1;
				}
